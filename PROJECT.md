...
| `Components/Shared/Archetypes/` | The page frame, one component per handoff structure: `PageHead`, `EmptyState`, `LoadingBlock`, `FilterBar`, and the page-level `LauncherPage`. Pages compose these instead of copying the markup — see "Page archetypes" below. |
