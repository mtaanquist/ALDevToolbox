...
public sealed class IgnoreQueryFiltersBaselineTests
{
    ...
    {
        ["ALDevToolbox/Components/Pages/AccountSecurity/OAuthConsent.razor"] = 2,
        ...
        ["ALDevToolbox/Endpoints/McpEndpoints.cs"] = 1,
        ["ALDevToolbox/Endpoints/OAuthEndpoints.cs"] = 1,
        ["ALDevToolbox/Endpoints/StartupTasks.cs"] = 7,
        ["ALDevToolbox/Endpoints/StrongAuthGate.cs"] = 3,
        ["ALDevToolbox/Services/Account/AuthService.cs"] = 9,
        ...
        ["ALDevToolbox/Services/Account/PendingSignupService.cs"] = 5,
        ...
        ["ALDevToolbox/Services/Account/UserAdministrationService.cs"] = 15,
        ["ALDevToolbox/Services/AccountService.cs"] = 9,
        ["ALDevToolbox/Services/BackupScheduler.cs"] = 2,
        ["ALDevToolbox/Services/DatabaseUsageService.cs"] = 3,
        ...
        ["ALDevToolbox/Services/ObjectExplorer/Bc/EnvironmentRefreshScheduler.cs"] = 1,
        ["ALDevToolbox/Services/ObjectExplorer/Bc/UpgradeActionWorker.cs"] = 1,
        ["ALDevToolbox/Services/ObjectExplorer/DeliveryScheduler.cs"] = 1,
        ...
        ["ALDevToolbox/Services/SiteAdminService.cs"] = 6,
        ["ALDevToolbox/Services/TemplateImportService.cs"] = 9,
    };
