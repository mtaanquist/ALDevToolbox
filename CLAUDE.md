...
- **Templates live in the DB at runtime.** TOML is seed-time only. There is no two-way sync. The export-to-TOML feature (Milestone 10) is a backup hatch, not a sync source.
