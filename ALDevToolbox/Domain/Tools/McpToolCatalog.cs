...
public static class McpToolCatalog
{
    ...
    public static readonly IReadOnlyList<McpToolDescriptor> All = new[]
    {
        ...
        new McpToolDescriptor("list_well_known_dependencies", Generation,
            "Lists the shared dependency catalogue, so the assistant can name a dependency correctly.", false),
        ...
        new McpToolDescriptor("find_system_references", ObjectExplorer,
            "The same, for platform types the base application does not declare.", false),
        ...
        new McpToolDescriptor("list_procedure_calls", ObjectExplorer,
            "Returns what one procedure calls and which fields it touches, for following a chain.", false),
        ...
        new McpToolDescriptor("get_cookbook_guidance", Cookbook,
            "Reads your organisation's house rules for writing a recipe. The assistant has to do "
            + "this before it may suggest or edit one.", false),
