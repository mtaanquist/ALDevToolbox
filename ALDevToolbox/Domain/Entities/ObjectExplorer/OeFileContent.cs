...
/// <see cref="OeModuleFile"/> — within a tenant, across modules/releases, and
...
/// <see cref="OeModuleFile.FileContent"/> navigation from an org-scoped
/// <see cref="OeModuleFile"/> — the same pattern <c>PasswordResetToken</c> /
/// <c>UserPasskey</c> use. Never query this table as a root or expose it
/// directly; never add an org filter to it.
/// </summary>
public class OeFileContent
{
