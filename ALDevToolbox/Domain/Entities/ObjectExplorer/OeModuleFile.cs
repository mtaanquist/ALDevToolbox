...
/// <summary>
/// One <c>.al</c> source file kept from a <see cref="OeModule"/>'s archive. Non-source artifacts
...
public class OeModuleFile
{
    ...
    /// the FK into the shared <see cref="OeFileContent"/> store — the actual
    ...
    /// </summary>
    public OeFileContent? FileContent { get; set; }
