...
namespace ALDevToolbox.Data.Migrations
{
    ...
    [Migration("20260522105947_AddSignupEmailDomainAllowlistAndRequireStrongAuth")]
    partial class AddSignupEmailDomainAllowlistAndRequireStrongAuth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ALDevToolbox.Domain.Entities.Snippet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ALDevToolbox.Domain.Entities.SnippetFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("OrganizationId", "SnippetId", "Ordering");

                    b.ToTable("snippet_files", (string)null);
                });

            modelBuilder.Entity("ALDevToolbox.Domain.Entities.SnippetSuggestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("ApprovedSnippetId")
                        .HasColumnType("integer")
                        .HasColumnName("approved_snippet_id");
                    ...
                    b.ToTable("snippet_suggestions", (string)null);
                });

            modelBuilder.Entity("ALDevToolbox.Domain.Entities.SnippetSuggestionFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("SnippetSuggestionId")
                        .HasColumnType("integer")
                        .HasColumnName("snippet_suggestion_id");

                    b.HasKey("Id");

                    b.HasIndex("SnippetSuggestionId");

                    b.HasIndex("OrganizationId", "SnippetSuggestionId", "Ordering");

                    b.ToTable("snippet_suggestion_files", (string)null);
                });
            ...
            modelBuilder.Entity("ALDevToolbox.Domain.Entities.SnippetFile", b =>
                {
                    b.HasOne("ALDevToolbox.Domain.Entities.Snippet", "Snippet")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("ALDevToolbox.Domain.Entities.SnippetSuggestion", b =>
                {
                    b.HasOne("ALDevToolbox.Domain.Entities.Snippet", "ApprovedSnippet")
                        .WithMany()
                        .HasForeignKey("ApprovedSnippetId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("ALDevToolbox.Domain.Entities.SnippetSuggestionFile", b =>
                {
                    b.HasOne("ALDevToolbox.Domain.Entities.SnippetSuggestion", "Suggestion")
                        .WithMany("Files")
                        .HasForeignKey("SnippetSuggestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
