...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ALDevToolbox.Domain.Entities.BaseAppExtension", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("VersionId", "AppId")
                        .IsUnique();

                    b.ToTable("base_app_extensions", (string)null);
                });

            modelBuilder.Entity("ALDevToolbox.Domain.Entities.BaseAppFile", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("VersionId", "ExtensionId");

                    b.HasIndex("VersionId", "ObjectType", "ObjectId");

                    b.HasIndex("VersionId", "ObjectType", "ObjectName");

                    b.ToTable("base_app_files", (string)null);
                });

            modelBuilder.Entity("ALDevToolbox.Domain.Entities.BaseAppSymbol", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("VersionId", "Kind", "Name");

                    b.ToTable("base_app_symbols", (string)null);
                });

            modelBuilder.Entity("ALDevToolbox.Domain.Entities.BaseAppVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("CumulativeUpdate")
                        .HasColumnType("integer")
                        .HasColumnName("cumulative_update");
                    ...
                    b.Property<DateTime?>("SymbolsIndexedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("symbols_indexed_at");
                    ...
                    b.HasIndex("OrganizationId", "Major", "CumulativeUpdate")
                        .IsUnique()
                        .HasFilter("deleted_at IS NULL");

                    b.ToTable("base_app_versions", (string)null);
                });
            ...
            modelBuilder.Entity("ALDevToolbox.Domain.Entities.BaseAppExtension", b =>
                {
                    ...
                    b.HasOne("ALDevToolbox.Domain.Entities.BaseAppVersion", "Version")
                        .WithMany()
            ...
            modelBuilder.Entity("ALDevToolbox.Domain.Entities.BaseAppFile", b =>
                {
                    b.HasOne("ALDevToolbox.Domain.Entities.BaseAppExtension", "Extension")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("ALDevToolbox.Domain.Entities.BaseAppSymbol", b =>
                {
                    b.HasOne("ALDevToolbox.Domain.Entities.BaseAppFile", "File")
                        .WithMany("Symbols")
