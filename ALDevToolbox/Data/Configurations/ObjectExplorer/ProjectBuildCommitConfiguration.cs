...
internal sealed class ProjectBuildCommitConfiguration : IEntityTypeConfiguration<OeProjectBuildCommit>
{
    public void Configure(EntityTypeBuilder<OeProjectBuildCommit> entity)
    {
