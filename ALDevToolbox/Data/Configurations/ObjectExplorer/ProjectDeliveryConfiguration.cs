...
internal sealed class ProjectDeliveryConfiguration : IEntityTypeConfiguration<OeProjectDelivery>
{
    public void Configure(EntityTypeBuilder<OeProjectDelivery> entity)
    {
