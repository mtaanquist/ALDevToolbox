...
internal sealed class ProjectDeliveryResultConfiguration : IEntityTypeConfiguration<OeProjectDeliveryResult>
{
    public void Configure(EntityTypeBuilder<OeProjectDeliveryResult> entity)
    {
