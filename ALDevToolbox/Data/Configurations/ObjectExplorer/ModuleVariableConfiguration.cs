...
internal sealed class ModuleVariableConfiguration : IEntityTypeConfiguration<OeModuleVariable>
{
    public void Configure(EntityTypeBuilder<OeModuleVariable> entity)
    {
