...
internal sealed class ProjectBuildLogConfiguration : IEntityTypeConfiguration<OeProjectBuildLog>
{
    public void Configure(EntityTypeBuilder<OeProjectBuildLog> entity)
    {
